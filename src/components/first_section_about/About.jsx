      ...
      <div className="px-5  max-w-[1560px]  mx-auto min-h-screen pt-20 flex items-center justify-between flex-wrap">
        <div data-aos="fade-right" className=" w-10/12 sm:w-8/12 mx-auto">
          <h1 className="font-semibold text-3xl	 text-white mb-3">
            Tax3v4der is a <span className="text-[#16B0CF]">web designer</span> and{" "}
            <span className="text-[#16B0CF]">front-end developer</span>
          </h1>
          <p className="text-[#ABB2BF] my-6">
            He crafts responsive websites where technologies meet creativity
          </p>
          <button className="text-white font-medium py-2 px-4 border duration-200 border-sky-400 hover:bg-sky-800">
            Contact me!!
          </button>
        </div>
        <div  data-aos="fade-left" data-aos-delay="400" className="mx-auto">
          <div className="">
            <img className="w-[400px] max-sm:hidden saturate-100" src={require("./imgs/man2.png")} alt="" />
          </div>
          <div className="border flex items-center gap-2 border-[#ABB2BF] p-2 text-[#ABB2BF]">
            <div className="w-4 h-4 bg-[#16B0CF]"></div>
            <div className="">
              Currently working on <span className="text-white">Mastering Next13 </span>
            </div>
          </div>
        </div>
      </div>
